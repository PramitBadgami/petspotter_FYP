        ...
        <div class="container">
            ...
            <div class="row pb-3">
                @if ($featuredProducts->isNotEmpty())
                    ...
                    @endphp
                    <div class="col-md-3">
                        <div class="card product-card" style="height: 400px; overflow: hidden;">
                            <div class="product-image position-relative">
                                <a href="" class="product-img">
                                    

                                    @if (!empty($productImage->image))
                                    <img class="card-img-top" src="{{ asset('uploads/product/small/'.$productImage->image) }}" style="object-fit: cover; object-position: center; width: 100%; height: 100%;" >
                                    @else
                                    <img src="{{ asset('admin-assets/img/default-150x150.png') }}" style="object-fit: cover; object-position: center; width: 100%; height: 100%;">
                                    @endif
                                </a>
