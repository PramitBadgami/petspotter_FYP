                        ...
                        @if ($wishlists->isNotEmpty())
                            ...
                            <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
                                <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                    ...
                                    @endphp
                                    <a class="d-block flex-shrink-1 mx-auto me-sm-4" href="{{ route("frontend.product", $wishlist->product->slug) }}" style="width: 10rem;">
                                    ...
                                    <div class="pt-2">
                                        ...
                                        <span class="h5"><strong>Rs.{{  $wishlist->product->price }}</strong></span>
                                        @if($wishlist->product->compare_price > 0)
                                        <span class="h6 text-underline"><del>Rs.{{ $wishlist->product->compare_price }}</del></span>
                                        @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            @else
                            <div>
                                <h3 class="h5">Your Wishlist is currently empty!!</h3>
                            </div>
                        @endif
                    </div>
                </div>
