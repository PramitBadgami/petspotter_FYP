...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="" name="subCategoryFomr" id="subCategoryFomr">
                <div class="card">
                    <div class="card-body">								
                        <div class="row">
                            <div class="col-md-12">
...
// Form Validation
$("#subCategoryFomr").submit(function(event){
    event.preventDefault();
    
    var element = $("#subCategoryFomr");
    $("button[type=submit]").prop('disabled', true);
    
    //with the help of ajax, the data is stored in the DB
    $.ajax({
